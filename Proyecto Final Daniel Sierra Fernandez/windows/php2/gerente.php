...
?>
  ...
  <div id="content-wrap">
    <div id="content">
      <div id="main">
        <li><a href="prin.php">Ver carta</a></li>
				<li><a href="insertar1.php">Insertar platos</a></li>
				<li><a href="eliminar.php">Eliminar platos</a></li>
				<li><a href="modificar1.php">Modificar platos</a></li>
      </div>
    </div>
  </div>
  <div id="footer">
